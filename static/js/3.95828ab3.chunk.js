...
(undefined.webpackJsonpweds = undefined.webpackJsonpweds || []).push([[3], {
  59: function _(t, n, e) {
    "use strict";
    ...
    var i,
      ...
      c || (f(), c = !0), addEventListener("visibilitychange", function (n) {
        var e = n.timeStamp;
      ...
      var n,
        ...
        t.hadRecentInput || (i.value += t.value, i.entries.push(t), n());
          ...
          r = u("layout-shift", a);
      r && (n = l(t, i, r, e), p(function (t) {
        var e = t.isUnloading;
        r.takeRecords().map(a), e && (i.isFinal = !0), n();
      }));
    },
        m = function m() {
      return void 0 === i && (i = "hidden" === document.visibilityState ? 0 : 1 / 0, p(function (t) {
        var n = t.timeStamp;
        return i = n;
      }, !0)), {
        get timeStamp() {
...
//# sourceMappingURL=3.95828ab3.chunk.js.map
